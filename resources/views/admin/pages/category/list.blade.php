                            ...
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <thead>
                                        ...
                                        @endif
                                        <tr role="row">
                                            <th rowspan="1" colspan="1"> Slide</th>
                                            <th rowspan="1" colspan="1"> Floor plan</th>
                                    ...
                                    <tbody>
                                        @foreach ($categories as $item)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><img src="{{ asset($item->img) }}" height="50"  alt=""></td>
                                                <td class="sorting_1"><img src="{{ asset($item->floor_plan) }}" height="50"  alt=""></td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/category/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/category/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger "
