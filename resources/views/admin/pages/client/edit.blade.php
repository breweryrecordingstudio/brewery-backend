                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ url('admin/client/edit_post') }}" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        </div>  <input type="hidden" name="id" value="{{ request()->route('id') }}">

                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="col-form-label">Contact</label>
                                                <input class="form-control" id="contact" name="contact" value="{{ $client->contact }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" id="description"  class="form-control"  cols="30" rows="10">{{ $client->description }}</textarea>
