            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Clients </h5>
                                    ...
                                    <tbody>
                                        @foreach ($clients as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1">{{ $item->contact }}</td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/client/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/client/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger "
