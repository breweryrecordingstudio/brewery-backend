                                    ...
                                    <tbody>
                                        @foreach ($employees as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1">{{  mb_strimwidth($item->clients, 0, 20, "...") }}</td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/employee/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/employee/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger "
