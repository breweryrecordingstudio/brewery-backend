                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Edit Floor Plan</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ url('admin/floor_plan/edit_post') }}" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="name" name="name" disabled value="{{ $category->name }}"
