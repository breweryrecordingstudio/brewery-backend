            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Floor plan </h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <thead>
                                        ...
                                        @endif
                                        <tr role="row">
                                            <th rowspan="1" colspan="1"> Floor plan Image</th>
                                            <th rowspan="1" colspan="1">Location Name</th>
                                            <th rowspan="1" colspan="1">Floor plan Image Edit</th>
                                        ...
                                        @foreach ($categories as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/floor_plan/edit/' . \Crypt::encrypt($item->id)) }}"
