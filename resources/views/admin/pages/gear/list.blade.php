            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Gear </h5>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th rowspan="1" colspan="1">Gear Status</th>
                                                ...
                                                <td class="sorting_1">
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            {{ $item->gear_status == 1? 'Enabled' : 'Disabled' }}
                                                        </button>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{ url('admin/gear/' . \Crypt::encrypt($item->id) . '/1') }}">Enable</a>
                                                            <a class="dropdown-item" href="{{ url('admin/gear/' . \Crypt::encrypt($item->id) . '/0') }}">Disable</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
