                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ url('admin/history/edit_post') }}" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="heading" name="heading" value="{{ $history->heading }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" id="description"  class="form-control"  cols="30" rows="10">{{ $history->description }}</textarea>
