            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Histories </h5>
                        <a href="{{url('admin/history/add')}}"
                                        ...
                                        @foreach ($histories as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/history/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/history/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger "
