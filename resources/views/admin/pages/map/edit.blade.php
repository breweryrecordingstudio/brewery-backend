...
@section('title', 'Edit Map & Address')
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Edit Map & Address</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ url('admin/map/edit_post') }}" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="name" disabled name="name" value="{{ $category->name }}"
