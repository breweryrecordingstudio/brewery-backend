...
@section('title', 'Add Other Service')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ url('admin/other_service/add_post') }}" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="heading_link" name="heading_link" value=""
