...
@section('title', 'Add Studio Booking')
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Add Studio Booking</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ url('admin/plan/add_post') }}" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="per_hour" name="per_hour" value=""
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="half_day" name="half_day" value=""
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="full_day" name="full_day" value=""
