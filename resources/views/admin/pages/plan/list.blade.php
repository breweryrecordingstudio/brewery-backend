            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Studio Booking </h5>
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th rowspan="1" colspan="1">Per Hour</th>
                                            <th rowspan="1" colspan="1">Half Day</th>
                                            <th rowspan="1" colspan="1">Full Day</th>
                                    ...
                                    <tbody>
                                        @foreach ($plans as $item)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><a href="{{ $item->link }}">{{ $item->heading }}</a></td>
                                                <td class="sorting_1">{{ $item->per_hour }}</td>
                                                <td class="sorting_1">{{ $item->half_day }}</td>
                                                <td class="sorting_1">{{ $item->full_day }}</td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/plan/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/plan/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger "
