            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Review </h5>
                        <a href="{{url('admin/review/add')}}"
                            ...
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <thead>
                                        ...
                                        @endif
                                        <tr role="row">
                                            <th rowspan="1" colspan="1">Image 1</th>
                                            <th rowspan="1" colspan="1">Image 2</th>
                                    ...
                                    <tbody>
                                        @foreach ($reviews as $item)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><img src="{{ asset($item->img1) }}" height="50"  alt=""></td>
                                                <td class="sorting_1"><img src="{{ asset($item->img2) }}" height="50"  alt=""></td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/review/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/review/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger "
