                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ url('admin/privacy_policy/edit_post') }}" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" id="summernote" >{!! $privacy_policy->description !!}</textarea>
                                            </div>
                                        </div>
