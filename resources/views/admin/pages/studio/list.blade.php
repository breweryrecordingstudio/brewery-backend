            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Studio Details </h5>
                        <a href="{{url('admin/studio/add')}}"
                                        ...
                                        @foreach ($studios as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/studio/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/studio/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger "
