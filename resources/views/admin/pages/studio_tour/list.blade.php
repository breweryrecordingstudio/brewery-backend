            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Studio Tours </h5>
                        <a href="{{url('admin/studio_tour/add')}}"
                        ...
                        <div class="table-responsive">
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <tbody>
                                        @foreach ($studio_tours as $item)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">{{ $item->heading }}</td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/studio_tour/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/studio_tour/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger "
